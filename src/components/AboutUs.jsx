    ...
    <div className="bg-gray-100 text-gray-900 dark:bg-gray-900 dark:text-white">
      ...
      <section className="relative py-24 flex items-center justify-center text-center bg-[#58130a] text-white overflow-hidden">
        ...
        >
          ...
          <p className="mt-4 text-lg max-w-3xl mx-auto">
            Empowering communities through knowledge – one book, one village at
            a time.
          </p>
        </motion.div>
      </section>
      ...
      <section className="container mx-auto px-6 py-20 text-center">
        ...
        >
          ...
          <p className="mt-6 text-lg max-w-3xl mx-auto text-gray-700 dark:text-gray-300">
            ...
            mission is to bring books to villages, creating spaces where people
            can learn, grow, and connect through literature.
          </p>
        </motion.div>
      </section>
        ...
        <div className="container mx-auto flex flex-col md:flex-row items-center gap-12 justify-center">
          ...
          >
            ...
            <p className="mt-4 text-lg text-gray-700 dark:text-gray-300">
              Many villages lack access to books, limiting education and growth.
              We started this initiative to bridge this gap, ensuring that
              knowledge reaches every corner, inspiring generations to come.
            </p>
          </motion.div>
          <motion.div
            whileHover={{ scale: 1.05 }}
      ...
      <section className="bg-gray-200 dark:bg-gray-800 py-20 px-6">
        ...
        >
          ...
          <h2 className="text-4xl font-bold mt-4">
            Prerequisites for Setting Up a Library
          </h2>
          <p className="mt-6 text-lg max-w-3xl mx-auto text-gray-700 dark:text-gray-300">
            To establish a library, your village must have a religious place
            where the library can be hosted. This ensures accessibility and
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <p className="mt-2 text-gray-700 dark:text-gray-300">
              Reach out to us, and we will walk you through the process.
            </p>
          </motion.div>
          <motion.div
            whileHover={{ scale: 1.05 }}
          ...
          >
            ...
            <p className="mt-2 text-gray-700 dark:text-gray-300">
              We assist you in organizing and setting up a library in a
              religious place.
            </p>
          </motion.div>
        </div>
      ...
      <section className="bg-white dark:bg-gray-800 py-20 px-6">
        ...
        >
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300">
            <strong>Sukhdev Singh Sandhu</strong>, the visionary behind{" "}
            <strong>Pind Pind Library</strong>, started this movement with the
            belief that every child and adult deserves access to books. His
            dedication to spreading literacy across rural villages has inspired
            communities to value education, knowledge, and growth.
          </p>
        </motion.div>
      </section>
      ...
      <section className="bg-[#58130a] text-white text-center py-20">
        ...
        >
          ...
          <p className="mt-4 text-lg max-w-3xl mx-auto">
            Be a part of our mission. Donate books, volunteer, or help us spread
            the word.
          </p>
